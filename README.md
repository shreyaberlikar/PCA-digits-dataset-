...
This project demonstrates how **Principal Component Analysis (PCA)** can reduce high-dimensional pixel data and reveal patterns within handwritten digit images.
